...
function Excel({filter}) {
    ...
    function save(e) {
        ...
        updateData(dataMangler(
            ...
            'save',
            {
                ...
                value,
                updateData,
                int: valueType === 'int' || valueType === 'rating'
            }
        ));
    }
    ...
    const handleAction = useCallback(
        (rowidx, type) => {
            ...
            } else if (type === 'info' || type === 'edit') {
                const isEdit = type === 'edit';
                const formPrefilled = data[rowidx];
                ...
                <thead onClick={sort}>
                    <tr>
                        {Object.keys(schema).map((key) => {
                            ...
                            return <th key={key} data-id={key}>{label}</th>;
                        })}
                    ...
                    {data.map((row, rowidx) => {
                        ...
                        return (
                            <tr key={rowidx} data-row={rowidx}>
                                ...
                                <td>
                                    <Actions onAction={handleAction.bind(null, rowidx)}></Actions>
                                </td>
                            </tr>
                        );
                    })}
